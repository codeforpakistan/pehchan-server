...
app.get('/callback', async (req, res) => {
  ...
  const client = await nc(req)
  client
    .authorizationCallback(`${redirect_uri}/callback`, req.query, {
...
app.get('/openid/userinfo', async (req, res) => {
  const client = await nc(req)
  client
    // .userinfo('vKYGWZ8gqapfooqTPSQ5l-nscD_CokBFeRmBnYtHn8c.dUCmvP6_yIdl8eM4oqsg6Cw6aIQAMzNN-GXgX59gzuc')
